...
float GameTimer::TotalTime()const
{
	...
	// Moreover, if we previously already had a pause, the distance  m_stopTime - mBaseTime includes paused time, which we do not want to count.
	...
	// The distance m_currTime - mBaseTime includes paused time, which we do not want to count.  To correct this, we can subtract  the paused time from mCurrTime:
	//
